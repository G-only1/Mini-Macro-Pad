...
//       break;
//     case 7://
//       Serial.println(F("Layout 1, key 7 pressed, opening calculator"));
//       Consumer.write(0x0192);
//       break;
//     case 8://
...
void Layout1(char button){
  switch(button){
    case 1://
      ...
      Keyboard.println(F("Layout 1, key 1 pressed"));
      break;
    case 2://
      Serial.println(F("Layout 1, key 2 pressed"));
      Keyboard.println(F("Layout 1, key 2 pressed"));
      break;
    case 3://
      Serial.println(F("Layout 1, key 3 pressed"));
      Keyboard.println(F("Layout 1, key 3 pressed"));
      break;
    case 4://
      Serial.println(F("Layout 1, key 4 pressed"));
      Keyboard.println(F("Layout 1, key 4 pressed"));
      break;
    case 5://
    ...
    case 6://Return
      ...
      Keyboard.println(F("Layout 1, key 6 pressed"));
      break;
    case 7://Escape
      Serial.println(F("Layout 1, key 7 pressed"));
      Keyboard.println(F("Layout 1, key 7 pressed"));
      break;
    case 8://
      Serial.println(F("Layout 1, key 8 pressed"));
      Keyboard.println(F("Layout 1, key 8 pressed"));
      break;
    case 9://
      Serial.println(F("Layout 1, key 9 pressed"));
      Keyboard.println(F("Layout 1, key 9 pressed"));
      break;
    case 10://
      Serial.println(F("Layout 1, key 10 pressed"));
      Keyboard.println(F("Layout 1, key 10 pressed"));
      break;
    case 11://
      Serial.println(F("Layout 1, key 11 pressed"));
      Keyboard.println(F("Layout 1, key 11 pressed"));
      break;
    case 12://
      Serial.println(F("Layout 1, key 12 pressed"));
      Keyboard.println(F("Layout 1, key 12 pressed"));
      break;
    case 13://
      Serial.println(F("Layout 1, key 13 pressed"));
      Keyboard.println(F("Layout 1, key 13 pressed"));
      break;
    case 14://
      Serial.println(F("Layout 1, key 14 pressed"));
      Keyboard.println(F("Layout 1, key 14 pressed"));
      break;
    case 15://
      Serial.println(F("Layout 1, key 15 pressed"));
      Keyboard.println(F("Layout 1, key 15 pressed"));
      break;
    case 16://
      Serial.println(F("Layout 1, key 16 pressed"));
      Keyboard.println(F("Layout 1, key 16 pressed"));
      break;
  };
}
